...
class Animals:
    ...
    def _setup_routes(self):
        ...
        async def get_animals_by_name(name: str):
        ...
        async def update_animal(animal_id: int, updates: dict, user: str = Header(...)):
        ...
        async def create_cats_by_breed(user: str = Header(...)):
